...
adding data ellipsoids. It also supports PCA-like objects calculated by
...
and [`MASS::lda()`](https://rdrr.io/pkg/MASS/man/lda.html).
...
and showing each correlation by an ellipse whose eccentricity and
shading represents the value of the correlation.
...
![](reference/figures/README-crime-corrplot-1.png)
...
![](reference/figures/README-crime-biplot1-1.png)
...
- In this standardized view, the angles between variable vectors
  ...
  $\cos\left( \text{angle} \right) \approx r$. Thus, `murder` and
  `auto`, nearly $90^{o}$ reflect a near 0 correlation.
...
![](reference/figures/README-wine-screeplot-1.png)
...
![](reference/figures/README-wine-biplot-1.png)
...
![](reference/figures/README-iris-biplot0-1.png)

It is possible to add annotations to the biplot by making use of the
fact that
[`ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.html)
returns a lot of information in the `"gg"` object. In particular, the
`$data` component contains the scores on the principal components that
are plotted as points here. Here we add direct labels for the groups and
suppress the legend.
...
![](reference/figures/README-iris-biplot1-1.png)
